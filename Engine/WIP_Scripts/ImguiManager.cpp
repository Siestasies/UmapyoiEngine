...
namespace Uma_Engine
{
    ...
    bool ImguiManager::IsInitialized() const { return m_initialized; }

    // for window controls
    void ImguiManager::ShowEngineDebug(bool show) { m_showEngineDebug = show; }
    void ImguiManager::ShowEventDebug(bool show) { m_showEventDebug = show; }
    void ImguiManager::ShowDemoWindow(bool show) { m_showDemoWindow = show; }
    void ImguiManager::ShowPerformanceWindow(bool show) { m_showPerformanceWindow = show; }
    void ImguiManager::ShowSystemsWindow(bool show) { m_showSystemsWindow = show; }
