...
namespace Uma_Engine
{
    ...
    private:
        ...
        void SpawnDefaultEntities()
        {
            ...
            // Create kappa statue
            Entity kappa = m_Scene->CreateEntity();
            {
                GetCoordinator().AddComponent(kappa, RigidBody{
                    .velocity = Vec2(0.0f, 0.0f),
                    .acceleration = Vec2(0.0f, 0.0f),
                    .accel_strength = 200,
                    .fric_coeff = 100
                ...
                GetCoordinator().AddComponent(kappa, Transform{
                    .position = Vec2(30, 35),
                    .rotation = Vec2(0, 0),
                    .scale = Vec2(3.f, 3.f)
                    });
                ...
                GetCoordinator().AddComponent(kappa, Sprite{
                    .textureName = texName,
                    .renderLayer = RL_ENV,
                    .flipX = false,
                    .flipY = false,
            ...
            // Create walls, floors, enemies, player, camera...
            // (Rest of SpawnDefaultEntities code from your EditorScene)

            std::cout << "Default entities spawned" << std::endl;
        }
