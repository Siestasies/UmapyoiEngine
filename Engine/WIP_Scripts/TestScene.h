...
namespace Uma_Engine
{
	class TestScene : public Scene
	{
        ...
        public:
            TestScene(SystemManager* sm) : pSystemManagerRef(sm) {}
		    void OnLoad() override
		    {
                ...
                pInputSystem = pSystemManagerRef->GetSystem<InputSystem>();
                pGraphics = pSystemManagerRef->GetSystem<Graphics>();
                pResourcesManager = pSystemManagerRef->GetSystem<ResourcesManager>();
                pEventSystem = pSystemManagerRef->GetSystem<EventSystem>();
                pSound = pSystemManagerRef->GetSystem<Sound>();
